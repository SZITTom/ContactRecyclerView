...
import com.szittom.contactrecyclerview.model.ContactItem;
...
public class ContactAdapter extends CommonRcvAdapter<SortModel>
        implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder>,SideBar.OnTouchingLetterChangedListener {

    private int mIndex;
    private boolean move;
    private RecyclerView mRecyclerView;

    public ContactAdapter(@Nullable List<SortModel> data) {
        super(data);
    }
    ...
    public void onBindHeaderViewHolder(ViewHolder holder, int position) {
        ...
        String showValue = String.valueOf(getData().get(position).sortLetters);
        if ("#".equals(showValue)) {
            textView.setText("#");
        }  else {
